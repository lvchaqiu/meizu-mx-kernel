...
int mx_set_mic_bias(bool onoff)
{
	int ret;
	ret = (onoff) ? 
		  ...
		  snd_soc_update_bits(wm8994_codec, WM8994_POWER_MANAGEMENT_1,
				WM8994_MICB2_ENA_MASK, 0);
	return ret;
}
EXPORT_SYMBOL(mx_set_mic_bias);
...
static int wm8994_codec_probe(struct snd_soc_codec *codec)
{
	...
	if(!machine_is_m030())
		snd_soc_write(codec, WM8958_MICBIAS2, 0x29);	/*2.2v,modified by lvcha, default:0x2E*/
