...
#define MAX8997_FLASH_EN_MASK			5
#define MAX8997_FLASH_EN_SHIFT		0
#define MAX8997_MOVIE_EN_MASK		2
#define MAX8997_MOVIE_EN_SHIFT		3

enum max8997_fled_boost_control {
	MAX8997_FLEDBOOST_DISABLE = 0x00,
	MAX8997_FLED_BOOST_ENABLE = 0x40,
};

enum max8997_fash_time {
	MAX8997_FLASH_TIME_800MS = 0x1f,
};

enum max8997_flash_timer_mode {
	MAX8997_FLASH_ONESHOT_MODE = 0x00,
	MAX8997_FLASH_MAX_TIMER_MODE = 0x40,
};

enum max8997_flash_timer_reset_control {
	MAX8997_FLASH_TIMER_RESET_ENABLE = 0x00,
	MAX8997_FLASH_TIMER_RESET_DISABLE = 0x80,
};
