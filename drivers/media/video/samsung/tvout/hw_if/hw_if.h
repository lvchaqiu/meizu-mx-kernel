...
#ifdef	CONFIG_HDMI_14A_3D
struct s5p_hdmi_v_format_m03x {
	struct s5p_hdmi_v_frame_m03x	frame;
...
struct s5p_hdmi_v_format_m030 {
	struct s5p_hdmi_v_frame_m030	frame;
// #else
...
#ifdef CONFIG_HDMI_14A_3D
extern void s5p_hdmi_reg_infoframe_m03x(struct s5p_hdmi_infoframe *info, u8 *data, u8 type_3D);
extern void s5p_hdmi_reg_tg_m03x(struct s5p_hdmi_v_format_m03x *v);
// #else
extern void s5p_hdmi_reg_infoframe_m030(struct s5p_hdmi_infoframe *info, u8 *data);
extern void s5p_hdmi_reg_tg_m030(struct s5p_hdmi_v_frame_m030 *frame);
#endif
extern void s5p_hdmi_reg_v_timing_m03x(struct s5p_hdmi_v_format_m03x *v);
extern void s5p_hdmi_reg_v_timing_m030(struct s5p_hdmi_v_format_m030 *v);
#ifdef CONFIG_HDMI_14A_3D
extern void s5p_hdmi_reg_bluescreen_clr_m03x(u16 b, u16 g, u16 r);
// #else
extern void s5p_hdmi_reg_bluescreen_clr_m030(u8 cb_b, u8 y_g, u8 cr_r);
#endif
