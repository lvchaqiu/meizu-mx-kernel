...
#define IRQ_PPMU_CORE_D_M0	COMBINER_IRQ(8, 0)	/* DMC LEFT */
#define IRQ_PPMU_CORE_D_M1	COMBINER_IRQ(8, 1)	/* DMC RIGHT */
#define IRQ_PPMU_CORE_D_S0	COMBINER_IRQ(8, 2)	/* CPU */
#define IRQ_PPMU_ACP0_M0	COMBINER_IRQ(8, 3)
#define IRQ_PPMU_D_LEFT_M0	COMBINER_IRQ(8, 4)	/* BUS LEFT */
#define IRQ_PPMU_D_RIGHT_M0	COMBINER_IRQ(8, 5)	/* BUS RIGHT */
#define IRQ_PPMU_CAMIF_M0	COMBINER_IRQ(8, 6)
#define IRQ_PPMU_IMAGE_M0	COMBINER_IRQ(8, 7)

#define IRQ_PPMU_LCD0		COMBINER_IRQ(9, 0)
#define IRQ_PPMU_LCD1		COMBINER_IRQ(9, 1)
#define IRQ_PPMU_FILE_D_M0	COMBINER_IRQ(9, 2)	/* FSYS */
#define IRQ_PPMU_TV_M0		COMBINER_IRQ(9, 2)
#define IRQ_PPMU_3D		COMBINER_IRQ(9, 4)
#define IRQ_PPMU_MFC_M0		COMBINER_IRQ(9, 5)	/* MFC LEFT */
#define IRQ_PPMU_MFC_M1		COMBINER_IRQ(9, 6) 	/* MFC RIGHT */
...
#endif
#elif defined(CONFIG_CPU_EXYNOS4212)
