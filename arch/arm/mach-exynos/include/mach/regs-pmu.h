...
#define S5P_USE_STANDBY_WFI2			(1 << 14)
#define S5P_USE_STANDBY_WFI3			(1 << 15)
#define S5P_USE_STANDBYWFI_ISP_ARM		(1 << 18)
#define S5P_USE_STANDBY_WFE0			(1 << 24)
#define S5P_USE_STANDBY_WFE1			(1 << 25)
#define S5P_USE_STANDBY_WFE2			(1 << 22)
#define S5P_USE_STANDBY_WFE3			(1 << 23)
#define S5P_USE_STANDBYWFE_ISP_ARM		(1 << 26)
#define S5P_USE_MASK				((0x3 << 16) | (0x3 << 24))

#define S5P_SWRESET				S5P_PMUREG(0x0400)

#define S5P_RST_STAT				S5P_PMUREG(0x0404)
