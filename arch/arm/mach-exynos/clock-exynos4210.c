...
static int exynos4210_clk_ip_lcd1_ctrl(struct clk *clk, int enable)
{
...
static struct clk init_clocks_off[] = {
	{
		.name		= "lcd",
		.devname		= "s3cfb.1",
		.enable		= exynos4210_clk_ip_lcd1_ctrl,
		.ctrlbit		= (1 << 0),
	}, {
		.name		= "mie1",
		.enable		= exynos4210_clk_ip_lcd1_ctrl,
...
static struct vpll_div_data vpll_div_4210[] = {
	{67737600, 4, 90, 3, 20762, 0, 17, 1 },
	{49152000, 3, 49, 3, 9961, 0, 17, 0},
	{45158400, 3, 45, 3, 10381, 0, 17, 0},
